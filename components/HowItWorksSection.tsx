    ...
    <div className="bg-[#FFFFE6]" style={{
      ...
      <div className="container flex flex-col items-center lg:gap-60  lg:flex-row ">
        <div className="lg:py-20 py-10">
          ...
          <div className='mt-2'>
            <h3 className="text-3xl sm:text-[52px] lg:leading-[60px]  font-bold mb-4">The starting point of your <br /> career Set up in minutes, <br /> <span className='text-[#E4E403]'>transforming ambition</span> into <br /> real opportunity</h3>
